          ...
          <Card className="border border-border shadow-sm" style={{ backgroundColor: '#981D17' }}>
            <CardContent className="p-6">
              ...
              <iframe
                ...
                src="https://bandcamp.com/EmbeddedPlayer/album=510068802/size=large/bgcol=ffffff/linkcol=0A5176/artwork=small/transparent=true/"
                seamless
          ...
          <Card className="border border-border shadow-sm" style={{ backgroundColor: '#8D3500' }}>
            <CardContent className="p-6">
              ...
              <iframe
                data-testid="embed-iframe"
                style={{ border: 0, width: '100%', height: '650px' }}
                src="https://bandcamp.com/EmbeddedPlayer/album=543644240/size=large/bgcol=ffffff/linkcol=0A5176/artwork=small/transparent=true/"
                seamless
